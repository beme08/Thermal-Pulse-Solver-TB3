...
Six Harbor Codex trials have been completed: one legitimate standard pass,
...
instance 2), and one final standard gatekeeper trial (reward 0.0, clean
numerical failure). Codex hardened standard trials: 4 valid runs, 0 exceptions,
...
| Codex final standard | 0.0 | clean numerical failure |
