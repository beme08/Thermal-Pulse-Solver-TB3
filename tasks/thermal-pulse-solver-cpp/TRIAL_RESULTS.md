...
Two Harbor standard Codex trials have been completed: one legitimate pass and
one clean numerical failure. No Harbor cheat trials have been run yet. The
multi-instance verifier smoke checks below are local/Docker checks, not Harbor
agent trials.
